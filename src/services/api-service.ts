...
export class ApiService {
    constructor(private http: HttpClient) {
        // Call the configure methdo to get the configuration object
        http.configure((config) => {
            // Prefix all API requests with this URL, it saves ut having to repeat it.
